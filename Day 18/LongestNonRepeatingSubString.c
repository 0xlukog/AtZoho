...
int UniqueorNot(char s[], int start, int end)
{
...
void printPalindromicSubString(char s[], int length)
{
    ...
    for (int i = 0; i < length; i++)
    {
        ...
        {
            if (palindromeOrNot(s, i, j)) // change as per requirement
            {
...
void main()
{
    char s[] = "madamcamotocollegesaippuakivikauppias"; // for palindrome
    // char s[] = "india"; // for unique 
